...
#  Virus: PBS only (Mock; collected during FHV replicates)
...
# Approach
#  As with FHV, utilise RMST as outlined in 1-2.
#  Notably: Due to low mortality in mock-injected populations, do not include BiolRep as a covariate.
#  Notably: Use same tau as with FHV Analysis, as to check survival difference during experiment timeline..
...
write.csv(
  final_results,
  "Table S7. RMST_FHV Mock-only.csv",
  row.names = FALSE
)
